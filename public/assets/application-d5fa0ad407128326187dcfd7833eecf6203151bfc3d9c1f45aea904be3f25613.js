  ...
  jQuery(function() {
    ...
    return $('#article_material_id').change(function() {
      ...
      if (options) {
        $('#article_category_ids').html(options);
        $('#article_category_ids').trigger("chosen:updated");
        return $('#article_category_ids').parent().show();
      } else {
        $('#article_category_ids').trigger("chosen:updated").empty();
        return $('#article_category_ids').parent().hide();
      }
    });
  });
...
(function() {
  jQuery(function() {
    ...
    return $('#article_subcategory_id').change(function() {
      material = $('#article_subcategory_id :selected').text();
      options = $(categories).filter("optgroup[label='" + material + "']").html();
      if (options) {
        $('#article_ssubcategory_id').html(options);
        return $('#article_ssubcategory_id').parent().show();
      } else {
        $('#article_ssubcategory_id').empty();
        return $('#article_ssubcategory_id').parent().hide();
      }
    });
  });
